"""
Fine-tuning script for DINO v2 models
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="DINO v2 Fine-tuning")
    parser.add_argument("--config", help="train config file path", required=True)
    parser.add_argument("--checkpoint", help="pretrained checkpoint file path")
...
def main():
    ...
    print(f"Starting DINO v2 fine-tuning with config: {args.config}")

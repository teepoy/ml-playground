"""
Fine-tuning script for MAE (Masked Autoencoders) models
Based on mmpretrain MAE benchmarks
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--checkpoint", help="pretrained checkpoint file path", required=True
    )
...
def main():
    ...
    print(f"Starting MAE fine-tuning with config: {args.config}")
